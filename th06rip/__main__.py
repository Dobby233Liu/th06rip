...
DEFAULT_GLOBAL_TAGS = [
    m3u.M3UVgmstreamGlobalTag("ALBUM ARTIST", "Team Shanghai Alice"),
    m3u.M3UVgmstreamGlobalTag("ARTIST", 'Jun\'ya "ZUN" Ōta'),
]
...
def main() -> None:
    ...
    for file in glob.iglob("*.wav", root_dir=bgm_dir):
        ...
        shutil.copy(os.path.join(bgm_dir, file), dir_ours)
        os.chmod(
